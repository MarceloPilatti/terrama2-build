...
wget -qO TerraMA2-${TERRAMA2_TAG}-release-linux-x64-Ubuntu-16.04.deb -L http://www.dpi.inpe.br/jenkins-data/terrama2/installers/linux/TerraMA2-${TERRAMA2_TAG}-release-linux-x64-Ubuntu-16.04.deb
valid $? "Error: Could not fetch TerraMA²"

echo -ne "Downloading TerraMA² documentation ..."
wget -qO terrama2-doc-${TERRAMA2_TAG}.deb -L http://www.dpi.inpe.br/jenkins-data/terrama2/installers/linux/terrama2-doc-${TERRAMA2_TAG}.deb
